...
export default function Testimonials() {
  ...
  <div className="grid grid-cols-2 md:grid-cols-3 gap-6 p-2 xl:p-0">
    {testimonials.map((item, i) => (
      <div
        key={i}
        className="flex flex-col h-full border border-[#D5D5D5] rounded-3xl md:rounded-4xl p-2 md:p-5 shadow-sm hover:shadow-md transition-all duration-300 bg-white"
      >
